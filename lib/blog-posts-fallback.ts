...
export const fallbackBlogPosts: BlogPost[] = [
  {
    ...
    description:
      "LEXIA BLOG開設の背景と発信していく内容について。愛知県碧南市から届ける制作現場の知見と最新トレンドを紹介します。",
    genre: "ideas",
    ...
    sections: [
      {
        body: [
          "LEXIA BLOGへようこそ。代表の齋藤です。愛知県碧南市を拠点に中小企業や個人事業主のみなさまと伴走してきたなかで、制作プロセスやマーケティングの考え方をもっと丁寧に伝える場が欲しいとずっと感じていました。",
