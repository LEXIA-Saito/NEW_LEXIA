      ...
      <main className="min-h-screen bg-white dark:bg-neutral-900">
              ...
              <div className="space-y-4">
                <div className="text-neutral-700 dark:text-neutral-300 text-sm space-y-3">
                  <p>
                    ...
                    <br />
                    「価値を技術で作り出し、語り継がれる成果を構築する」──その想いが、私たちの原点です。
                  </p>
                  <p>
                    WEBという形のない媒体に、 お客様の想い、情報を刻み、 そこに更なる成果を作り出すこと。
                    <br />
                    それこそが、私たちLEXIAの使命です。
                  </p>
                  ...
                  <p>LEXIAは事業活動を通じて、 お客様の"価値"を作り出し、歴史に残るような"伝説"を共に創る存在であり続けます。</p>
        ...
        <section className="container mx-auto px-4 py-24 space-y-4" data-testid="access" id="access">
          ...
          <div className="w-full h-64 md:h-96">
            <iframe
              title="LEXIA所在地"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3273.5372830014103!2d136.99312047575168!3d34.86785237286076!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6004912fde7e69e1%3A0xacdd229f402ed916!2sLEXIA!5e0!3m2!1sja!2sjp!4v1758245732121!5m2!1sja!2sjp"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              loading="lazy"
